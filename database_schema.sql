...
CREATE TABLE task_document_links (
  ...
  FOREIGN KEY (linkedBy) REFERENCES users(id) ON DELETE CASCADE,
  UNIQUE KEY unique_task_document (taskId, documentId),
  INDEX idx_task (taskId),
...
VALUES (
  ...
  '$2b$10$hash_placeholder_replace_with_actual_hash', 
  'Admin', 
  'User', 
  TRUE, 
  TRUE
